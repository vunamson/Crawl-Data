        ...
        try:
            async with session.get(url, headers=headers, params=params) as response:
                if response.status == 429:
                    print(f"⚠️ Rate limit hit for ID {product_id}. Sleeping 60s and retrying...")
...
async def main(start_id, end_id, max_concurrent_requests):
    ...
    excel_output_path = "recame_nfl_v2_0403.xlsx"
...
if __name__ == "__main__":
    start_id = 1000000569483306
    end_id =   1000000569513306
